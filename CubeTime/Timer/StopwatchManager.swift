...
class StopWatchManager: ObservableObject {
    ...
    // MARK: scrambler
    private var scrambleWorkItem: DispatchWorkItem?
    
    
    
    // MARK: private
    private var prevScrambleStr: String! = nil
    private let plusTwoTime: Int = 15
    private let dnfTime: Int = 17
